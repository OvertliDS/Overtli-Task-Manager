...
const STOP_WORDS = new Set([
  'the','and','for','with','that','this','from','you','your','are','was','were','will','shall','can','could','would','should','into','onto','than','then','them','they','have','has','had','not','but','about','over','under','again','also','only','just','like','what','when','where','why','how','all','any','each','more','most','some','such','make','made','use','using','used'
]);
